...
class AVDDevice:
    ...
    def wrap_ctrl_device_init(self):
        ...
        avd_w32(0x1400014, 0x1) # idle thing
        avd_w32(0x1400018, 0x1) # AVD_CTRL_BLK_CLOCKGATEENABLE
        avd_w32(0x1070000, 0x0) # GEN2P0_APIODMA_APIODMA_CFG
        avd_w32(0x1104064, 0x3)
        avd_w32(0x110cc90, 0xffffffff) # irq mask
        avd_w32(0x110cc94, 0xffffffff) # irq mask
        avd_w32(0x110ccd0, 0xffffffff) # irq mask
        avd_w32(0x110ccd4, 0xffffffff) # irq mask
        avd_w32(0x110cac8, 0xffffffff) # irq mask
        avd_w32(0x1070024, 0x26907000)
        avd_w32(0x1400014, 0x0)
